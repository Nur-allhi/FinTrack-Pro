...
This project is indexed by GitNexus as **FinTrack-Pro** (2632 symbols, 3981 relationships, 94 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
