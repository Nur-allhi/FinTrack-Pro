...
This project is indexed by GitNexus as **FinTrack-Pro** (2366 symbols, 3557 relationships, 91 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
