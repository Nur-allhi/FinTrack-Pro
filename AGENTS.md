...
This project is indexed by GitNexus as **FinTrack-Pro** (1438 symbols, 2086 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
