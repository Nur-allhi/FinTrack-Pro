...
This project is indexed by GitNexus as **FinTrack-Pro** (1958 symbols, 4177 relationships, 152 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
