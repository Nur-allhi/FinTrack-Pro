...
This project is indexed by GitNexus as **FinTrack-Pro** (2835 symbols, 4319 relationships, 149 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
