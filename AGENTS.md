...
This project is indexed by GitNexus as **FinTrack-Pro** (2287 symbols, 4395 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
