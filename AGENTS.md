...
This project is indexed by GitNexus as **FinTrack-Pro** (1988 symbols, 2937 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
