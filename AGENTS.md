...
This project is indexed by GitNexus as **FinTrack-Pro** (1731 symbols, 3723 relationships, 126 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
