...
ALTER TABLE members ADD COLUMN IF NOT EXISTS user_id UUID NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

-- 2. Add user_id column to accounts
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS user_id UUID NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

-- 3. Add user_id column to transactions
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS user_id UUID NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

-- 4. Add user_id column to investments
ALTER TABLE investments ADD COLUMN IF NOT EXISTS user_id UUID NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

-- 5. Add user_id column to investment_returns
ALTER TABLE investment_returns ADD COLUMN IF NOT EXISTS user_id UUID NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
