...
export default function TransactionModal({ accounts, onClose, onUpdate, initialAccountId }: TransactionModalProps) {
        ...
        <div className="p-8">
          {success ? (
            <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-slate-900">Transaction Saved</h4>
                <p className="text-slate-500">The ledger has been updated successfully.</p>
              </div>
            </div>
          ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex p-1 bg-slate-100 rounded-2xl">
                      <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all ${!tx.isCredit ? 'bg-rose-500 text-white shadow-sm' : 'text-slate-500'}`}
                      >
                        DEBIT
                      </button>
                      <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all ${tx.isCredit ? 'bg-emerald-500 text-white shadow-sm' : 'text-slate-500'}`}
                      >
                        CREDIT
                      </button>
                    </div>
