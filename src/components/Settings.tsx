          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-ink">Export Data Ledger</p>
                  <p className="text-xs text-muted">Download complete history as JSON</p>
                </div>
              </div>
            </button>
            <button 
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-semantic-down">Clear Local Audit</p>
                  <p className="text-xs text-semantic-down/60">Reset local session and cache</p>
                </div>
              </div>
            </button>
          </div>
